...
const InstitutionPhoto: React.FC<{
  ...
  return (
    <div className={`${sizeClass} rounded-2xl overflow-hidden border-2 border-slate-100 shadow-sm flex-shrink-0 cursor-zoom-in group/photo relative bg-slate-100`}>
      <img
        src={photoUrl}
        alt={name}
                ...
                <div>
                  ...
                  <div className="space-y-2 pt-2">
                    ...
                    <div className="flex justify-between text-[11px] font-semibold text-slate-600">
                      <span className="text-brand-blue whitespace-nowrap">Fonct. : {functioningPct}% ({formatAmountInWords(inst.budget_functioning_fcfa)})</span>
                      <span className="text-emerald-700 whitespace-nowrap">Invest. : {investmentPct}% ({formatAmountInWords(inst.budget_investment_fcfa)})</span>
                    </div>
                  </div>
                </div>
