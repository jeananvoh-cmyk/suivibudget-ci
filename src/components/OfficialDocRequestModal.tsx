  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ========================================================================= */}
        <div className="overflow-y-auto p-4 sm:p-6 space-y-5 bg-slate-50/70 flex-1">
        ...
        {/* ========================================================================= */}
        {/* ACTION BUTTONS STICKY FOOTER (CONTEXTUEL & HARMONISÉ) */}
        {/* ========================================================================= */}
        <div className="p-3 sm:p-4 bg-white border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-2.5 flex-shrink-0">
          <div className="text-xs text-slate-600 font-medium w-full sm:w-auto text-center sm:text-left">
            {activeTab === 'SELECTION' && (
              <span className="font-semibold text-slate-700">
                <strong className="text-brand-blue font-black">{selectedDocIds.length}</strong> document{selectedDocIds.length > 1 ? 's' : ''} sélectionné{selectedDocIds.length > 1 ? 's' : ''}
              </span>
            )}
            {activeTab === 'FORM' && (
              <span className="text-slate-600 text-xs">
                Délai légal : <strong className="text-brand-blue font-bold">{legalDelayDays} jours</strong> (Loi n°2013-867)
              </span>
            )}
            {activeTab === 'PREVIEW' && (
              hasDirectEmail ? (
                ...
                <span className="text-[11px] text-slate-500">
                  Dépôt physique au secrétariat ou téléprocédure sur caidp.ci
                </span>
              )
            )}
          </div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            {activeTab === 'SELECTION' && (
              <button
                type="button"
                onClick={() => setActiveTab('FORM')}
                className="w-full sm:w-auto px-5 py-2.5 bg-brand-blue hover:bg-brand-blue-dark text-white rounded-xl text-xs font-black shadow-xs flex items-center justify-center gap-2 transition-all cursor-pointer"
              >
            ...
            {activeTab === 'FORM' && (
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <button
                  type="button"
                  onClick={() => setActiveTab('SELECTION')}
                  className="flex-1 sm:flex-none px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold transition-colors cursor-pointer"
                >
                  ← Documents
                </button>
                <button
                  type="button"
                  onClick={() => setActiveTab('PREVIEW')}
                  className="flex-1 sm:flex-none px-5 py-2.5 bg-brand-blue hover:bg-brand-blue-dark text-white rounded-xl text-xs font-black shadow-xs flex items-center justify-center gap-2 transition-all cursor-pointer"
                >
            ...
            {activeTab === 'PREVIEW' && (
              <div className="flex items-center gap-2 w-full sm:w-auto flex-wrap sm:flex-nowrap">
                ...
                <button
                  ...
                  className="flex-1 sm:flex-none px-3.5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 shadow-2xs cursor-pointer"
                ...
                <button
                  type="button"
                  onClick={handlePrint}
                  className="flex-1 sm:flex-none px-3.5 py-2 bg-slate-800 hover:bg-slate-900 text-white rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 shadow-xs cursor-pointer"
                ...
                {hasDirectEmail ? (
                  <button
                    ...
                    className="w-full sm:w-auto px-4 py-2 bg-brand-blue hover:bg-brand-blue-dark text-white rounded-xl text-xs font-black transition-all flex items-center justify-center gap-1.5 shadow-xs cursor-pointer"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full sm:w-auto px-4 py-2 bg-brand-orange hover:bg-brand-orange-dark text-white rounded-xl text-xs font-black transition-all flex items-center justify-center gap-1.5 shadow-xs cursor-pointer"
                  >
