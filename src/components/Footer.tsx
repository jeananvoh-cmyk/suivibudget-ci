            ...
            <div className="pt-2">
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-emerald-50 hover:bg-emerald-600 text-emerald-700 hover:text-white border border-emerald-200 transition-all text-xs font-bold shadow-2xs cursor-pointer"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-blue-50 hover:bg-[#1877F2] text-[#1877F2] hover:text-white border border-blue-200 transition-all text-xs font-bold shadow-2xs cursor-pointer"
